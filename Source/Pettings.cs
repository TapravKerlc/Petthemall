...
{
    public class Pettings_JobDriver : OutsidePath_JobDriver
    {
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            sayByeToAnimal.socialMode = RandomSocialMode.SuperActive;
            sayByeToAnimal.AddPreInitAction(setJog);

            // return toils
            return new Toil[] {
                gotoAnimalInitial, sayHelloToAnimal, sayByeToAnimal
            };
        }
    }
}
