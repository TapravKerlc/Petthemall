...
namespace PetThemAll
    ...
    public class PetThemAll : Mod {
        ...
        public PetThemAll(ModContentPack content) : base(content) {
        ...
        public static void Debug(string message, [CallerLineNumberAttribute] int line = 0, [CallerMemberName] string caller = null) {
            if (MessageAlways || MessageInDevMode && Prefs.DevMode) {
                Log.Message($"[PetThemAll @ {caller}:{line}] {message}");
            }
        }
    ...
    public class Settings : ModSettings {
        public override void ExposeData() {
            Scribe_Values.Look(ref PetThemAll.MessageInDevMode, "MessageInDevMode", PetThemAll.MessageInDevModeDefault, true);
            Scribe_Values.Look(ref PetThemAll.MessageAlways, "MessageAlways", PetThemAll.MessageAlwaysDefault, true);
